...
exports.BRANCH_INDEX = exports.STEM_INDEX = exports.NAYIN_TABLE = void 0;
exports.getNayin = getNayin;
exports.getNayinIndex = getNayinIndex;
exports.getNayinName = getNayinName;
exports.getFiveElementBureau = getFiveElementBureau;
...
function getNayin(stem, branch) {
    ...
    return exports.NAYIN_TABLE[key] || { bureau: '土五局' };
}
/**
 * Get the index in the 60-year cycle (0-59)
 */
function getNayinIndex(stem, branch) {
    const stemIdx = exports.STEM_INDEX[stem];
    const branchIdx = exports.BRANCH_INDEX[branch];
    return (stemIdx + 60 - branchIdx) % 10 * 6 + branchIdx;
}
/**
 * Get Nayin name
 */
function getNayinName(stem, branch) {
 ...
 */
function getFiveElementBureau(stem) {
    switch (stem) {
        case types_1.HeavenlyStem.JIA:
        case types_1.HeavenlyStem.YI:
            return '木三局'; // Wood Bureau
        case types_1.HeavenlyStem.BING:
        case types_1.HeavenlyStem.DING:
            return '火六局'; // Fire Bureau
        case types_1.HeavenlyStem.WU:
        case types_1.HeavenlyStem.JI:
            return '土五局'; // Earth Bureau
        case types_1.HeavenlyStem.GENG:
        case types_1.HeavenlyStem.XIN:
            return '金四局'; // Metal Bureau
        case types_1.HeavenlyStem.REN:
        case types_1.HeavenlyStem.GUI:
